    ...
    <header class="surface-girih sticky top-0 z-40 border-b border-brass/25 bg-ink">
        <div class="mx-auto flex h-16 max-w-7xl items-center gap-3 px-4 sm:gap-6">
            ...
            <div class="flex shrink-0 items-center gap-1 sm:gap-2">
                ...
                {{-- Cart --}}
                <button type="button" id="cart-icon" x-on:click="$dispatch('open-mini-cart')" class="relative flex size-10 items-center justify-center rounded-lg text-paper hover:bg-paper/10" aria-label="{{ __('Cart') }}">
