<x-account-shell active="messages" :title="__('Messages')">
    ...
    <div class="flex h-[600px] max-h-[72vh] overflow-hidden rounded-[10px] border border-line bg-surface">
        {{-- ===== Thread list ===== --}}
            ...
            @if ($active)
                ...
                <form wire:submit="send" class="border-t border-line p-3">
                    @if ($contextProduct !== null)
                        <div class="mb-2 flex items-center gap-2 rounded-[10px] border border-line bg-paper px-2.5 py-1.5">
                            <span class="block size-9 shrink-0 overflow-hidden rounded-lg border border-line bg-surface">
                            ...
                            <button type="button" wire:click="removeContext"
                                    class="flex size-11 shrink-0 items-center justify-center rounded-lg text-ink-soft transition-colors duration-150 hover:text-ink"
