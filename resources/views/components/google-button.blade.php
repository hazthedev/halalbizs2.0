...
@if ($security->googleEnabled())
    <div>
        ...
        <a href="{{ route('auth.google.redirect') }}"
           class="mt-4 inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-[var(--radius-control)] border border-ink px-4 py-2.5 text-sm font-medium text-ink transition-colors duration-150 hover:bg-paper focus:outline-none focus-visible:ring-2 focus-visible:ring-emerald focus-visible:ring-offset-2">
